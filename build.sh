...
ZIPNAME="RyzenKernel-AOSP-Ginkgo-$(TZ=Asia/Baku date +"%Y%m%d-%H%M").zip"
ZIPNAME_KSU="RyzenKernel-AOSP-Ginkgo-KSU-$(TZ=Asia/Baku date +"%Y%m%d-%H%M").zip"
...
export KBUILD_BUILD_USER="shawk"
export KBUILD_BUILD_HOST="munir"
